...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		if(type == 'define'){
			var $ok = $('<a data-toggle="modal" data-target="#responsive">').addClass("sgBtn").addClass("ok").text("Ok");//确定按钮
		}else if(type == 'shop'){
			var $ok = $('<a>').addClass("sgBtn").addClass("ok").text("Cart");//确定按钮
		}else{
			var $ok = $('<a>').addClass("sgBtn").addClass("ok").text("Ok");//确定按钮
		}
		if(type == 'shop'){
			var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text("Continuation");//取消按钮
		}else{
			var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text("Cancel");//取消按钮
		}
		var $input = $("<input>").addClass("inputBox");//输入框
		if(type != 'shop'){
			var $clsBtn = $("<a>").addClass("clsBtn").addClass('glyphicon').addClass('glyphicon-remove');//关闭按钮
		}else{
